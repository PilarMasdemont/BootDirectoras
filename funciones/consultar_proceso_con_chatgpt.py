...
def consultar_proceso_chatgpt(nombre_proceso: str, atributo_dudado: str) -> str:
    if not openai.api_key:
        return "❌ No se ha configurado la clave de OpenAI. Define la variable de entorno OPENAI_API_KEY."

    if not nombre_proceso:
        return "❗️No estoy segura a qué proceso te refieres. ¿Podrías especificarlo un poco más?"

    # Buscar proceso similar
...
No inventes datos que no estén presentes. Sé directa, útil y cercana.
